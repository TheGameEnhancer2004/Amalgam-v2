...
MAKE_SIGNATURE(TeamFortress_CalculateMaxSpeed, "client.dll", "40 53 41 56 41 57 48 81 EC ? ? ? ? 48 83 3D ? ? ? ? ? 44 0F B6 FA 48 8B D9 0F 84 ? ? ? ? 48 8B 01 44 8B B1 ? ? ? ? FF 90 ? ? ? ? 85 C0 74 ? 48 8B 03 48 8B CB FF 90 ? ? ? ? 83 F8 07", 0x0);
