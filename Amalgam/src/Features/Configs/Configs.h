...
public:
	...
	void SaveJson(boost::property_tree::ptree& t, const std::string& s, const std::vector<std::pair<std::string, ChamsMaterial_t>>& v);
	...
	void SaveJson(boost::property_tree::ptree& t, const std::string& s, const ESP_t& v);
	...
	void LoadJson(const boost::property_tree::ptree& t, const std::string& s, std::vector<std::pair<std::string, ChamsMaterial_t>>& v);
	...
	void LoadJson(const boost::property_tree::ptree& t, const std::string& s, ESP_t& v);
